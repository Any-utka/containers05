...
Создаем базу данных *wordpress* и пользователя *wordpress* с паролем *wordpress* в контейнере *apache2-php-mariadb*. Для этого, в контейнере *apache2-php-mariadb*, выполняем команды:
